    ...
    context "when there are 5 entries in the audit logs" do
      ...
      it "returns an array of assessment status events that match the requested event type" do
        ...
        expect(results).to contain_exactly(
          { reportRrn: "0000-0000-0000-0000-0001", newStatus: "OPTED OUT", timeOfChange: be_an_instance_of(Time) },
          { reportRrn: "0000-0000-0000-0000-0002", newStatus: "OPTED IN", timeOfChange: be_an_instance_of(Time) },
          { reportRrn: "0000-0000-0000-0000-0004", newStatus: "CANCELLED", timeOfChange: be_an_instance_of(Time) },
        )
      end
