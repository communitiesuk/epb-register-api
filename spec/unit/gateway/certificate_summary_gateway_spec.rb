describe Gateway::CertificateSummaryGateway, :set_with_timecop do
  ...
  before do
    ...
    domestic_rdsap_s_xml = Nokogiri.XML Samples.xml("RdSAP-Schema-S-19.0")
    domestic_sap_xml = Nokogiri.XML Samples.xml("SAP-Schema-19.0.0")
    domestic_sap_s_xml = Nokogiri.XML Samples.xml("SAP-Schema-S-19.0.0")
    domestic_rdsap_s_xml.at("RRN").content = "0000-0000-0000-0000-0002"
    domestic_sap_s_xml.at("RRN").content = "0000-0000-0000-0000-0003"
  ...
  describe "#fetch" do
    ...
    it "returns the expected data for a Scottish RdSAP certificate" do
      expected_data_without_xml = {
        "created_at" => Time.utc(2021, 2, 22),
        "opt_out" => false,
        "cancelled_at" => nil,
        "not_for_issue_at" => nil,
        "assessment_address_id" => "RRN-0000-0000-0000-0000-0002",
        "country_name" => "Unknown",
        "scheme_assessor_id" => "SPEC000000",
        "scheme_id" => scheme_id,
        "assessor_first_name" => "Someone",
      ...
      result = gateway.fetch("0000-0000-0000-0000-0002", is_scottish: true)
      expect(result.count).to eq(17)
      expect(result["xml"]).to be_a String
      expect(result).to include expected_data_without_xml
    end
    ...
    it "returns the expected data for a Scottish SAP certificate" do
      result = gateway.fetch("0000-0000-0000-0000-0003", is_scottish: true)
      expect(result.count).to eq(17)
    end
