describe Gateway::PrsDatabaseGateway do
  ...
  let(:expected_non_dom_rrn_response) do
    {
  ...
  let(:expected_rdsap_uprn_response) do
    {
      "address_line1" => "1 Some Street",
      "address_line2" => "",
      "address_line3" => "",
  ...
  let(:expected_sap_uprn_response) do
    {
      "address_line1" => "1 Some Street",
  ...
  let(:expected_cancelled_uprn_response) do
    {
      "address_line1" => "1 Some Street",
      "address_line2" => "",
      "address_line3" => "",
      ...
      "epc_rrn" => "0000-0000-0000-0000-0000",
      "expiry_date" => "2030-05-03",
      "latest_epc_rrn_for_address" => "0000-0000-0000-0000-0000",
      "type_of_assessment" => "RdSAP",
    }
  end

  let(:expected_newer_uprn_response) do
    {
      "address_line1" => "1 Some Street",
      "address_line2" => "",
      "address_line3" => "",
      ...
      "postcode" => "SW1A 2AA",
      "current_energy_efficiency_rating" => 50,
      "epc_rrn" => "0000-0000-0000-0000-0004",
      "expiry_date" => "2036-05-04",
      "latest_epc_rrn_for_address" => "0000-0000-0000-0000-0004",
      "type_of_assessment" => "RdSAP",
    }
  end
  ...
  context "when searching by UPRN" do
    ...
    context "when the only certificate is an non-domestic assessment" do
      it "returns nil when no match" do
        expect(gateway.search_by_uprn("UPRN-000000000011")).to be_nil
      end
    end
    ...
    context "with a cancelled certificate" do
      ...
      it "does not return the cancelled certificate" do
        result = gateway.search_by_uprn("UPRN-000000000000")
        expect(result).not_to include("epc_rrn" => "0000-0000-0000-0000-0002")
      end

      it "returns the latest certificate at the UPRN" do
        result = gateway.search_by_uprn("UPRN-000000000000")
        expect(result).to eq expected_cancelled_uprn_response
      end
    end
    ...
    context "when the UPRN was different at lodgement for the same property" do
      before do
        ...
        rdsap_xml.at("Completion-Date").content = "2026-05-05"
        rdsap_xml.at("Registration-Date").content = "2026-05-05"
      ...
      it "returns the most recent assessment" do
        result = gateway.search_by_uprn("UPRN-000000000000")
        expect(result).to eq expected_newer_uprn_response
      end
    end
  ...
  context "when searching by RRN" do
    it "finds and returns the expected data when one match exists", :aggregate_failures do
      ...
      expect(result).to eq expected_rrn_response
    end
    ...
    it "finds and returns the expected data when one match exists for a non-dom certificate" do
      ...
      expect(result).to eq expected_non_dom_rrn_response
    end
