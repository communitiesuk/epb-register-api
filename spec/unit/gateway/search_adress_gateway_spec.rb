describe Gateway::SearchAddressGateway, set_with_timecop: true do
  ...
  describe "#insert" do
    ...
    it "the saved data is correct" do
      ...
      saved_data = ActiveRecord::Base.connection.exec_query("SELECT * FROM search_address")
  ...
  describe "#bulk_insert" do
    ...
    it "doesn't contain empty spaces when there are empty address lines" do
      ...
      gateway.bulk_insert
      saved_data = ActiveRecord::Base.connection.exec_query("SELECT * FROM search_address WHERE assessment_id='0000-0000-0000-0000-0000'")
