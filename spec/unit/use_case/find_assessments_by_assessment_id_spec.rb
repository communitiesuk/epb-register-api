describe UseCase::FindAssessmentsByAssessmentId do
  ...
  before do
    ...
    allow(assessments_search_gateway).to receive(:search_by_assessment_id).with("0000-0000-0000-0000-0000", { restrictive: false }).and_return([assessment1])
    allow(assessments_search_gateway).to receive(:search_by_assessment_id).with("0000-0000-0000-0000-0001", { restrictive: false }).and_return([assessment2])
  end
  ...
  describe ".execute" do
    ...
    it "returns cancelled certificates" do
      expect(use_case.execute("0000-0000-0000-0000-0001")).to eq(expected_data_2)
    end
  end
end
