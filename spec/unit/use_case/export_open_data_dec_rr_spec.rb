describe UseCase::ExportOpenDataDecrr do
  ...
  context "when creating the open data reporting release" do
    describe "for the DEC recommendation reports" do
      ...
      let(:dec_minus_rr_xml) { Nokogiri.XML Samples.xml("CEPC-8.0.0", "dec-rr") } # should not be present in export
      let(:dec_minus_rr_xml_id) { dec_minus_rr_xml.at("//RRN") }
      let(:dec_plus_rr_xml_date) { dec_minus_rr_xml.at("//Registration-Date") }
