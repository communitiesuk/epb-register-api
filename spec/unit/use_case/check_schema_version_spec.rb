describe UseCase::CheckSchemaVersion do
  ...
  before do
    ...
    allow(ENV).to receive(:[]).with("VALID_DOMESTIC_SCHEMAS").and_return("SAP-Schema-19.2.0,SAP-Schema-19.1.0,SAP-Schema-19.0.0,SAP-Schema-18.0.0,RdSAP-Schema-NI-19.0")
  ...
  it "returns true for the latest SAP schema version" do
    expect(use_case.execute("SAP-Schema-19.2.0")).to be(true)
  end
