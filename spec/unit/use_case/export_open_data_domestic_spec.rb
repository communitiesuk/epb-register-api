  ...
  context "when creating the open data reporting release" do
    ...
    context "for domestic certificates using hashed assessment ids" do
      ...
      it "returns the correct data" do
        ...
        expect(exported_assessment.first).to eq({ assessment_id: "4af9d2c31cf53e72ef6f59d3f59a1bfc500ebc2b1027bc5ca47361435d988e1a",
                                                  inspection_date: "2020-05-04",
                                                  lodgement_date: "2021-06-21",
                                                  address1: "1 Some Street",
                                                  address2: "",
                                                  address3: "",
                                                  posttown: "Whitbury",
                                                  ...
                                                  mainheatc_env_eff: "Good",
                                                  glazed_type: "double glazing installed during or after 2002",
                                                  lodgement_datetime: "2021-06-21 00:00:00",
                                                  building_reference_number: "UPRN-000000000000",
                                                  region: "London" })
      end
    end
