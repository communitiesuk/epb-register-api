...
describe ViewModel::AcReportWrapper do
  context "when calling to_hash" do
    let(:schemas) do
      [
        { schema: "CEPC-8.0.0", type: "ac-report" },
        { schema: "CEPC-NI-8.0.0", type: "ac-report" },
        {
          schema: "CEPC-7.1",
          type: "ac-report",
          different_buried_fields: {
        ...
        { schema: "CEPC-6.0", type: "ac-report" }.merge(pre_7_differences),
        { schema: "CEPC-5.0", type: "ac-report" }.merge(pre_7_differences),
        { schema: "CEPC-4.0", type: "ac-report" }.merge(pre_7_differences),
      ]
    end
