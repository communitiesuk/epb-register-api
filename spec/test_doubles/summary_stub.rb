class SummaryStub
    ...
    { type_of_assessment: "SAP",
      ...
      assessor:
        { first_name: "Someone",
          ...
          contact_details: { email: "a@b.c", telephone_number: "111222333" } },
      current_carbon_emission: 2.4,
      carbon_emissions_current_per_floor_area: "5.6",
      current_energy_efficiency_band: "c",
      current_energy_efficiency_rating: 72,
      dwelling_type: "Mid-terrace house",
      estimated_energy_cost: "689.83",
  ...
  def self.fetch_certificate_summary_scottish_sap_19(scheme_id)
    { type_of_assessment: "SAP",
      ...
      carbon_emissions_current_per_floor_area: 12.1,
      current_energy_efficiency_band: "b",
      current_energy_efficiency_rating: 91,
      dwelling_type: "Detached house",
      estimated_energy_cost: "837.00",
      heat_demand: { current_space_heating_demand: nil, current_water_heating_demand: nil },
      heating_cost_current: "603",
      heating_cost_potential: "603",
      hot_water_cost_current: "152",
      hot_water_cost_potential: "152",
      lighting_cost_current: "82",
      lighting_cost_potential: "82",
      potential_carbon_emission: 2.2,
      potential_energy_efficiency_band: "b",
      potential_energy_efficiency_rating: 91,
      potential_energy_saving: "0.00",
      property_summary: [{ energy_efficiency_rating: 5, environmental_efficiency_rating: 5, name: "walls", description: "Average thermal transmittance 0.21 W/m²K" }, { energy_efficiency_rating: 5, environmental_efficiency_rating: 5, name: "roof", description: "Average thermal transmittance 0.14 W/m²K" }, { energy_efficiency_rating: 5, environmental_efficiency_rating: 5, name: "floor", description: "Average thermal transmittance 0.16 W/m²K" }, { energy_efficiency_rating: 4, environmental_efficiency_rating: 4, name: "windows", description: "High performance glazing" }, { energy_efficiency_rating: 5, environmental_efficiency_rating: 4, name: "main_heating", description: "Boiler and radiators, mains gas" }, { energy_efficiency_rating: 5, environmental_efficiency_rating: 5, name: "main_heating_controls", description: "Time and temperature zone control" }, { energy_efficiency_rating: 0, environmental_efficiency_rating: 0, name: "secondary_heating", description: "None" }, { energy_efficiency_rating: 4, environmental_efficiency_rating: 4, name: "hot_water", description: "From main system" }, { energy_efficiency_rating: 5, environmental_efficiency_rating: 5, name: "lighting", description: "Excelent lighting efficiency" }, { energy_efficiency_rating: 4, environmental_efficiency_rating: 4, name: "air_tightness", description: "Air permeability [AP50] = 4.0 m³/h.m² (as tested)" }],
      recommended_improvements: [],
      lzc_energy_sources: [11],
      related_party_disclosure_number: 1,
      related_party_disclosure_text: nil,
      total_floor_area: 184,
      status: "ENTERED",
      environmental_impact_current: 88,
      environmental_impact_potential: 88,
      primary_energy_use: 63.0,
      addendum: nil,
      gas_smart_meter_present: true,
