describe "Acceptance::AssessmentStatus::DEC" do
  ...
  context "when cancelling an DEC assessment" do
    let(:response) do
      ...
      lodge_assessment assessment_body: valid_dec_xml,
  ...
  context "when marking an DEC assessment not for issue" do
    let(:response) do
      scheme_id = add_scheme_and_get_id
