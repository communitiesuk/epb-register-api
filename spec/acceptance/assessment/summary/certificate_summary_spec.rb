      ...
      let(:expected_response) do
        { data:
           { typeOfAssessment: "SAP",
             ...
             potentialEnergySaving: "174.83",
             propertySummary:
              [{ energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "walls", description: "Brick walls" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "walls", description: "Brick walls" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "roof", description: "Slate roof" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "roof", description: "slate roof" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "floor", description: "Tiled floor" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "floor", description: "Tiled floor" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "windows", description: "Glass window" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "main_heating", description: "Gas boiler" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "main_heating", description: "Gas boiler" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "main_heating_controls", description: "Thermostat" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "main_heating_controls", description: "Thermostat" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "secondary_heating", description: "Electric heater" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "hot_water", description: "Gas boiler" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "lighting", description: "Energy saving bulbs" },
               { energyEfficiencyRating: 0, environmentalEfficiencyRating: 0, name: "air_tightness", description: "Draft Exclusion" }],
             recommendedImprovements:
              [{ energyPerformanceRatingImprovement: 50,
                 environmentalImpactRatingImprovement: 50,
                 greenDealCategoryCode: "1",
