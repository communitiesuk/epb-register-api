...
describe "Acceptance::ScotlandCertificateSummary", :set_with_timecop do
  ...
  context "when requesting Scottish assessments" do
    ...
    before do
      add_countries
      insert_into_address_base("0000000001", "", "", "", "", "S")
    ...
    context "when requesting an RdSAP-Schema-S-22.0.0 assessment" do
      let(:related_assessment) { [] }
      let(:green_deal_plan) { [] }
      let(:superseded_by) { nil }
      let(:date_of_expiry) { "2030-05-03" }
      ...
      let(:expected_response) do
        { typeOfAssessment: "RdSAP",
          ...
          gasSmartMeterPresent: false,
          electricitySmartMeterPresent: false,
          addressId: "UPRN-0000000000",
          optOut: false,
          relatedAssessments: [],
          supersededBy: nil,
          countryName: "Scotland",
          schemaType: "RdSAP-Schema-S-22.0.0",
          greenDealPlan: [] }
      end

      before do
        domestic_rdsap_22_xml = Nokogiri.XML Samples.xml("RdSAP-Schema-S-22.0.0")
        lodge_scottish_assessment(
          assessment_body: domestic_rdsap_22_xml.to_xml,
          accepted_responses: [201],
          auth_data: {
            scheme_ids: [scheme_id],
          },
    ...
    context "when requesting a Scottish Action Plan 8.0.0 assessment" do
      before do
        action_plan_xml = Nokogiri.XML Samples.xml("CS63-S-8.0.0", "cs63")
        action_plan_xml
          .xpath("//*[local-name() = 'RRN']")
          .each do |node|
          node.content = "0000-0000-0000-0003-0000"
    ...
    context "when requesting a Scottish Action Plan 7.0 assessment" do
      before do
          ...
          expected_response = { assessmentId: "0000-0000-0000-0004-0000",
                                ...
                                assessor:
                                  { schemeAssessorId: "SPEC000000",
                                    ...
                                    lastName: "Person",
                                    registeredBy: { name: "test scheme", schemeId: scheme_id } },
                                administrativeInformation: { issueDate: "2025-04-10", calculationTool: "IES Ltd, Virtual Environment, v7.0.26, SBEM, v6.1.e.1", relatedPartyDisclosure: "1" },
                                relatedRrn: nil,
                                addressId: "UPRN-0000000001",
                                optOut: false,
                                relatedAssessments: [],
        ...
        it "returns the expected DEC-AR" do
          ...
          expected_response = { typeOfAssessment: "DEC-AR",
                                ...
                                administrativeInformation: {
                                  ...
                                  calculationTool: "IES Ltd, Virtual Environment, v7.0.26, SBEM, v6.1.e.1",
                                },
        ...
        it "returns the expected DEC-AR" do
          ...
          expected_response_ar = { typeOfAssessment: "DEC-AR",
                                  ...
                                  { buildingEnvironment: "Heating and Natural Ventilation",
                                    ...
                                    discountedEnergy: nil,
                                    inspectionType: "Physical" },
                                   administrativeInformation: { issueDate: "2023-06-27", calculationTool: "IES Ltd, Virtual Environment, v7.0.26, SBEM, v6.1.e.1" },
          ...
          expected_response_dec = { assessmentId: "0000-0000-0000-0000-0040",
                                    ...
                                    assessor:
                                      { schemeAssessorId: "SPEC000000",
                                        ...
                                        lastName: "Person",
                                        registeredBy: { name: "test scheme", schemeId: scheme_id } },
                                    administrativeInformation: { issueDate: "2023-06-27", calculationTool: "IES Ltd, Virtual Environment, v7.0.26, SBEM, v6.1.e.1", relatedPartyDisclosure: "4" },
          ...
          expected_response = { assessmentId: "0000-0000-0000-0004-0000",
                                ...
                                assessor:
                                  { schemeAssessorId: "SPEC000000",
                                    ...
                                    lastName: "Person",
                                    registeredBy: { name: "test scheme", schemeId: scheme_id } },
                                administrativeInformation: { issueDate: "2023-06-27", calculationTool: "IES Ltd, Virtual Environment, v7.0.26, SBEM, v6.1.e.1", relatedPartyDisclosure: "1" },
                                relatedRrn: nil,
