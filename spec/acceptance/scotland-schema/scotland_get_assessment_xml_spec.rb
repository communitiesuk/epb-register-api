describe "Acceptance::ScotlandGetAssessmentXml", :set_with_timecop do
  ...
  it_behaves_like "when checking an endpoint requires bearer token access", end_point: "scotland/v1/assessments/some_id/xml-data", scopes: %w[scotland_data:fetch]
