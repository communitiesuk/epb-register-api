...
deploy-app: ## Deploys the app to PaaS
	...
	cf set-env "${DEPLOY_APPNAME}" DOMESTIC_APPROVED_SOFTWARE "${DOMESTIC_APPROVED_SOFTWARE}"
	cf set-env "${DEPLOY_APPNAME}" NON_DOMESTIC_APPROVED_SOFTWARE "${NON_DOMESTIC_APPROVED_SOFTWARE}"
