...
CREATE TABLE public.green_deal_plans (
    ...
    savings_scotland jsonb DEFAULT '"[]"'::jsonb NOT NULL,
...
--
-- Name: green_deal_assessments fk_scotland_green_deal_plan_id_green_deal_plans; Type: FK CONSTRAINT; Schema: scotland; Owner: -
--

ALTER TABLE ONLY scotland.green_deal_assessments
    ADD CONSTRAINT fk_scotland_green_deal_plan_id_green_deal_plans FOREIGN KEY (green_deal_plan_id) REFERENCES public.green_deal_plans(green_deal_plan_id) ON DELETE CASCADE;
