module Domain
  class RdsapAssessment
    ...
    attr_accessor :lighting_cost_current
    ...
    def to_record
      {
        ...
        address_line4: @address_line4,
        town: @town,
        lighting_cost_current: BigDecimal(@lighting_cost_current),
        heating_cost_current: BigDecimal(@heating_cost_current),
        hot_water_cost_current: BigDecimal(@hot_water_cost_current),
        lighting_cost_potential: BigDecimal(@lighting_cost_potential),
        heating_cost_potential: BigDecimal(@heating_cost_potential),
        hot_water_cost_potential: BigDecimal(@hot_water_cost_potential),
