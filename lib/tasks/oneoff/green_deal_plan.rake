...
namespace :oneoff do
  ...
  # This task needs the url environment variable to point to a server that will
  # send Green Deal plan data as a JSON object.  It was used to import Green Deal
  # plans from the old Landmark database, but should not be run again.
