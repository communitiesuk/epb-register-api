module ViewModel::Export
  class DomesticExportView < ExportBaseView
    def build
      ...
      view[:glazed_area] = @view_model.glazed_area.to_i unless @view_model
        .glazed_area.nil?
      unless @view_model.habitable_room_count.nil?
        view[:habitable_room_count] = @view_model.habitable_room_count.to_i
      end
      ...
      unless @view_model.heated_room_count.nil?
        view[:heated_room_count] = @view_model.heated_room_count.to_i
      end
      ...
      unless @view_model.related_party_disclosure_number.nil?
      ...
      view[:storey_count] = @view_model.storey_count.to_i unless @view_model
        .storey_count.nil?
      ...
      unless @view_model.unheated_corridor_length.nil?
        view[:unheated_corridor_length] =
          @view_model.unheated_corridor_length.to_i
      end
