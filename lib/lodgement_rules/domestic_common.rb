        ...
        test:
          lambda do |adapter|
            ...
            unless walls.nil?
              unless walls
                       .compact
                       .select { |desc| desc.downcase == "wall" }
                       .empty?
                return false
              end
            end
            ...
            unless roofs.nil?
              unless roofs
                       .compact
                       .select { |desc| desc.downcase == "roof" }
                       .empty?
                return false
              end
            end
            ...
            unless floors.nil?
              unless floors
                       .compact
                       .select { |desc| desc.downcase == "floor" }
                       .empty?
                return false
              end
            end
            ...
            unless windows.nil?
              unless windows
                       .compact
                       .select { |desc| desc.downcase == "window" }
                       .empty?
                return false
              end
            end
            ...
            unless main_heating.nil?
              unless main_heating
                       .compact
                       .select { |desc| desc.downcase == "main-heating" }
                       .empty?
                return false
              end
            end
            ...
            unless hot_water.nil?
              unless hot_water
                       .compact
                       .select { |desc| desc.downcase == "hot-water" }
                       .empty?
                return false
              end
            end
            ...
            unless lighting.nil?
              unless lighting
                       .compact
                       .select { |desc| desc.downcase == "lighting" }
                       .empty?
                return false
              end
            end
            ...
            unless secondary_heating.nil?
              unless secondary_heating
                       .compact
                       .select { |desc| desc.downcase == "secondary-heating" }
                       .empty?
                return false
              end
            end
      ...
      },
      {
        ...
        test:
          lambda do |adapter|
            ...
            roof_room_connected =
              !building_parts
                .map { |part| part[:roof_room_connected] }
                .select { |flag| flag&.upcase == "Y" }
                .empty?
