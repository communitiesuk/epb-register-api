...
module UseCase
  class ValidateAndLodgeAssessment
    ...
    LATEST_COMMERCIAL = %w[CEPC-8.0.0 CEPC-NI-8.0.0 CEPC-S-7.1 CEPC-S-8.0.0].freeze
    SCOTTISH_DEC_DECAR_CS63 = %w[CS63-S-7.0 CS63-S-8.0.0 DECAR-S-7.0 DECAR-S-8.0.0].freeze
    NOT_OVERRIDABLE_LODGEMENT_RULES = %w[
      ...
      SCOTLAND_PARTY_WALLS_ARE_NOT_APPLICABLE_FOR_DETACHED_PROPERTIES_VAL001
      SCOTLAND_PARTY_WALLS_ARE_NOT_DEFINED_USING_CURRENT_SURVEY_INFORMATION_VAL003
      SCOTLAND_INSPECTION_DATE_LATER_THAN_COMPLETION_DATE_VAL009
      SCOTLAND_COMPLETION_DATE_IS_NOT_THE_SAME_AS_DATE_OF_LODGEMENT_VAL011
      SCOTLAND_WALL_THICKNESS_MEASURED_IS_N_BUT_WALL_THICKNESS_PRESENT_VAL008
      SCOTLAND_INSPECTION_DATE_LATER_THAN_COMPLETION_DATE_VAL100
      SCOTLAND_COMPLETION_DATE_IS_NOT_THE_SAME_AS_DATE_OF_LODGEMENT_VAL102
      SCOTLAND_INSPECTION_DATE_LATER_THAN_COMPLETION_DATE_VAL200
      SCOTLAND_ROOF_INSULATION_LOCATION_CANNOT_BE_5_VAL050
      SCOTLAND_INSULATION_IN_ROOM_IN_ROOF_IS_1_VAL051
      SCOTLAND_FLOOR_INSULATION_THICKNESS_AND_FLOOR_U_VALUE_CANNOT_BOTH_BE_PRESENT_VAL052
      SCOTLAND_ONLY_ONE_ROOF_INSULATION_VALUE_PERMITTED_VAL053
      SCOTLAND_ONLY_ONE_WALL_INSULATION_VALUE_PERMITTED_VAL054
      SCOTLAND_ONLY_ONE_ROOM_IN_ROOF_INSULATION_VALUE_PERMITTED_VAL055
      SCOTLAND_ONLY_ONE_ALTERNATIVE_WALL_INSULATION_VALUE_PERMITTED_VAL056
      SCOTLAND_ONLY_ONE_MAIN_HEATING_VALUE_PERMITTED_VAL057
      SCOTLAND_MAIN_HEATING_CODE_MUST_BE_699_OR_310_VAL059
      SCOTLAND_WATER_HEATING_CODE_MUST_BE_999_OR_953_VAL060
    ].freeze
    ...
    def execute(assessment_xml:, schema_name:, scheme_ids:, migrated:, overridden:)
      ...
      raise LodgementFailsCountryConstraintError if (schema_name == "SAP-Schema-19.2.0") && !(country_lookup.country_codes.include?(:E) && %w[EAW ENG].include?(lodgement_domain.country_code))
